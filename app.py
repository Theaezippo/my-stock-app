...
if stock_symbol:
    ...
    try:
        # ใช้ yf.Ticker() แทนการ download ปกติ เพื่อแก้ปัญหา Yahoo ส่งข้อมูลมาผิดรูปแบบ
        ...
        if data.empty:
            ...
            # บังคับให้ข้อมูลราคาเป็นตัวเลขเพียวๆ ป้องกันการเออเร่อ

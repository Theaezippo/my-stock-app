...
if app_mode == "📈 โหมดการลงทุน (Wealth Allocation)":
    ...
    with tab1:
        ...
        asset_class = st.radio("เลือกประเภทสินทรัพย์ที่ต้องการนำเสนอ:", 
                               ["🇹🇭 หุ้นไทย", "🇺🇸 หุ้นระดับโลก & ETF", "🛢️ สินทรัพย์ทางเลือก (ทอง, น้ำมัน, จีน)", "🏦 กองทุน SCB"], horizontal=True)
                ...
                try:
                    ...
                    if not data.empty:
                        ...
                        if asset_class == "🛢️ สินทรัพย์ทางเลือก (ทอง, น้ำมัน, จีน)":
                            script = f"คุณลูกค้าคะ นิวขออนุญาตอัปเดตภาพรวมนะคะ สภาวะโลกมีความไม่แน่นอนสูง นิวแนะนำให้มี **{asset_name}** ติดพอร์ตไว้เพื่อเป็น 'เบาะกันกระแทก' และกระจายความเสี่ยงค่ะ เผื่อเกิดเหตุการณ์ไม่คาดฝัน พอร์ตจะได้ยังปลอดภัยค่ะ"
                        elif drawdown < -15:
                            script = f"สวัสดีค่ะคุณลูกค้า นิวติดตาม **{asset_name}** ให้นะคะ ราคาปรับฐานลงมา {abs(drawdown):.1f}% นิวและทีมมองว่าเป็น **'โอกาสทองในการทยอยสะสม'** นิวแบ่งไม้เข้าให้ดีไหมคะ จะได้ต้นทุนเฉลี่ยสวยๆ ค่ะ"
                        elif drawdown > -5:
                            script = f"คุณลูกค้าคะ ตอนนี้ราคาวิ่งขึ้นมาใกล้จุดสูงสุดแล้ว เพื่อวินัยที่ดี นิวแนะนำให้ทำ **Portfolio Rebalancing** ดีไหมคะ? ทยอยรินขายทำกำไรบางส่วน เอาเงินสดมารอจังหวะตลาดปรับฐานค่ะ"
                        else:
        ...
        elif asset_class == "🏦 กองทุน SCB":
            st.markdown("""<div class='script-box'>👩‍💼 <b>นิว:</b> "คุณลูกค้าคะ ตอนนี้ตลาดหุ้นจีน (SCBCE) Valuation ถูกมาก น่าสะสมค่ะ ส่วนเทรนด์โลก นิวแนะนำ SCBS&P500 และ SCBNDQ เป็น Core พอร์ตระยะยาวนะคะ ส่วนเงินเย็นพักไว้ที่หุ้นกู้ชั้นนำ นิวทำจองผ่านแอปให้ได้เลยค่ะ"</div>""", unsafe_allow_html=True)
        ...
        with colA:
            ...
            try:
                ...
                for item in root.findall('./channel/item'):
                    if count >= 10: # ดึงมา 10 ข่าวล่าสุด
                        break
